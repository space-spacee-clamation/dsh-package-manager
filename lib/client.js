window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const styles = {
			...
			hotCard: {
				borderColor: ACCENT_BORDER,
				background: "rgba(88,136,255,0.06)"
			},
			disabledCard: {
				opacity: .52,
		...
		*/
		...
		function PackageManagerTab({ t }) {
			...
			const resultOverlay = result !== null || logs.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			const noticeStack = restartBanner !== null || webRefreshBanner !== null || error !== "" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: styles.noticeStack,
				children: [
					restartBanner,
					webRefreshBanner,
											...
											children: [
												...
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
														...
														children: [
															...
															entry.adapter === "dsh-bundle" && entry.packageName !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
																style: styles.mono,
												...
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
														...
														disabled: busy,
														onClick: () => void run(() => api(off ? "/enable" : "/disable", {
															profile: entry.profile,
															id: entry.id
														})),
														children: off ? t("off") : t("on")
													}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
														type: "button",
														style: {
															...styles.button,
