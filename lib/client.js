									...
									children: visibleLocalPlugins.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												...
												children: item.active ? t("on") : item.released ? t("localReleased") : t("localCached")
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
												type: "button",
												style: item.released || !item.active ? styles.toggleOn : styles.toggleOff,
												disabled: busy,
												onClick: () => void run(() => api(item.released || !item.active ? "/local-plugins/restore" : "/local-plugins/release", { name: item.name })),
												children: item.released || !item.active ? t("localRestore") : t("localRelease")
											})
										]
