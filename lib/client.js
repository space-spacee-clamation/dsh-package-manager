		...
		*/
		...
		const styles = {
			...
			item: {
				...
				flexDirection: "column",
				gap: 8,
				background: "var(--dsw-surface, rgba(255,255,255,0.012))"
			},
			meta: {
				fontSize: 12,
				opacity: .78,
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
									...
									onClick: () => void run(() => api("/ai-install", { source: source.trim() })),
									children: busy ? t("running") : t("dispatchToAi")
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								style: styles.intro,
								children: t("aiInstallNote")
							})
						]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: (state?.entries ?? []).map((entry) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											entry.pluginEnvDir !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												style: styles.mono,
												children: [
													t("env"),
													": ",
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
									...
									style: styles.badge,
									children: (state?.disabled ?? []).length
								})]
							}),
