	...
	factory: (require) => {
		...
		*/
		...
		function PackageManagerTab({ t }) {
			...
			const [localSearch, setLocalSearch] = (0, react.useState)("");
			...
			const visibleLocalPlugins = localQuery === "" ? localPlugins : localPlugins.filter((item) => item.name.toLowerCase().includes(localQuery));
			const clearOutput = () => {
				setLogs([]);
				setResult(null);
				setError("");
			};
			const resultOverlay = result !== null || logs.length > 0 || error !== "" || state?.webRefreshNeeded === true ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
														...
														children: [entry.sourceKind === "git" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
															type: "button",
															style: styles.button,
															disabled: busy,
															title: t("checkUpdate"),
															onClick: () => void run(() => api("/check-update", {
																profile: entry.profile,
																id: entry.id
															})),
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
											style: styles.title,
											children: t("localPluginsTitle")
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											style: styles.badge,
											children: localPlugins.length
										})]
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										style: styles.row,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											...
											style: styles.button,
											disabled: busy,
											onClick: () => void run(() => api("/local-plugins/refresh", {})),
											children: t("localPluginsRefresh")
										})]
									})]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: styles.intro,
									children: t("localPluginsHint")
								}),
								visibleLocalPlugins.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									style: styles.intro,
									children: t("localPluginsEmpty")
								}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: styles.localGrid,
									children: visibleLocalPlugins.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										style: styles.localRow,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											style: styles.localTop,
											children: [
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: {
													...styles.statusDot,
													...item.active ? {} : { background: "#9aa0a8" }
												} }),
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												...
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
													...
													disabled: busy,
													onClick: () => void run(() => api(item.active ? "/local-plugins/release" : "/local-plugins/restore", { name: item.name })),
													children: item.active ? t("on") : t("off")
												})
											]
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											style: styles.row,
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												style: item.active ? styles.hotBadge : styles.badge,
												children: item.active ? t("localRunning") : item.released ? t("localReleased") : t("localCached")
											}), item.uid !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												style: styles.mono,
												children: ["fiber ", String(item.uid)]
											})]
										})]
									}, `${item.name}-${String(item.uid)}`))
								})
							]
						})]
