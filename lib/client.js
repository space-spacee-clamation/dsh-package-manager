window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			workspaceSwitchHint: "切换路径后会自动按目标目录的 requirements/deps.yaml 对齐：安装缺失插件、关闭多余插件。",
			switchPath: "切换",
		...
		const en = {
			...
			workspaceSwitchHint: "Switching paths reconciles against the target directory requirements/deps.yaml: missing plugins are installed and extra plugins are closed.",
			switchPath: "Switch",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							style: styles.intro,
							children: t("workspaceSwitchHint")
						}),
