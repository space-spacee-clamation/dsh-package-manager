window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			localPluginsHint: "通过 Cordis fiber 实时发现，非本管理器安装",
		...
		const en = {
			...
			localPluginsHint: "Discovered live from Cordis fibers, not installed by this manager",
					...
					page === "workspace" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								style: styles.row,
								children: localPlugins.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: styles.badge,
									children: item.name
